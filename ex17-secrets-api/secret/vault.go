...
import (
	...
	"github.com/acharyab/gophercises/ex17-secrets-api/encrypt"
)
...
// File returns a Vault from memory
...
// Get returns the value of the encoding key
...
// Set will set the value of the encoding key
