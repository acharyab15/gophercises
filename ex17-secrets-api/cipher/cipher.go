...
// Encrypt will take in a key and a plaintext and return a hex representation of the
// encrypted value.
...
// Decrypt will take in a key and a cipherHex (hexed representation of the
